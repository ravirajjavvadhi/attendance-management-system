  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (e.response?.statusCode == 404) {
        msg = e.response?.data?['detail'] ?? 'Account not found. Please contact your institution.';
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Use the email registered by your institution. Contact your college admin if you need help.',
